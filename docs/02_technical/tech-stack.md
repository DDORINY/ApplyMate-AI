...
v0.1.0에서는 서비스 기반 구축 범위에 맞춰 Next.js, TypeScript, Tailwind CSS만 우선 적용한다. TanStack Query, Zustand, React Hook Form, Zod, FullCalendar는 실제 기능이 도입되는 버전에서 적용한다.
...
v0.1.0의 필수 검증은 Backend Pytest, Frontend lint, TypeScript 검사, production build, Docker Compose 설정 검증이다.
