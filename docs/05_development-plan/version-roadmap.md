...
| v0.3.0 | 완료 | 이력서 PDF/DOCX 업로드, 파일 메타데이터, 다운로드/삭제 | [v0.3.0](../11_releases/v0.3.0-resume-upload.md) |

## 예정 버전

| 버전 | 상태 | 목적 |
| --- | --- | --- |
| v0.3.1 | 완료 | 이력서 텍스트 추출, 사용자 수정, 재추출, 실행 이력 | [v0.3.1](../11_releases/v0.3.1-resume-extraction.md) |
| v0.3.2 | 진행 중 | AI 이력서 구조화 분석 | [v0.3.2](releases/v0.3.2-plan.md) |
